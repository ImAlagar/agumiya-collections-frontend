...
return (
  <div className="relative z-10 w-full sm:w-auto">
    ...
    <motion.button
      ...
      className="flex items-center justify-between w-full sm:w-auto space-x-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl px-3 sm:px-4 py-2 text-sm sm:text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      disabled={isLoading}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          transition={{ duration: 0.2 }}
          className="absolute top-full right-0 sm:right-0 mt-2 w-[90vw] sm:w-80 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl shadow-xl z-50 overflow-hidden"
          role="dialog"
