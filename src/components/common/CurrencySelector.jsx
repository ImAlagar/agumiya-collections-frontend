  ...
  return (
    <div className="relative z-10">
      ...
      <motion.button
        ...
        className="flex items-center space-x-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors min-w-[120px] justify-between focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        disabled={isLoading}
        ...
        {isLoading ? (
          ...
          <>
            <div className="flex items-center space-x-2">
              ...
              <span className="truncate">{currentCurrency.symbol}</span>
              <span className="font-semibold truncate">{userCurrency}</span>
            </div>
            <motion.span
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl shadow-xl z-50 overflow-hidden"
            role="dialog"
            ...
            <div className="p-3 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
